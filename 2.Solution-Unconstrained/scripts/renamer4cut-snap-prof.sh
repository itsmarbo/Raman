...
for f in *.com; do
   ...
   cd $filename
     ...
     cp "RR_Spectrum_2D.dat_$filename3" /home/marlene/uracil/1.S0_snapshots/S1/0-100_S1
     echo "$filename files moved!"
     cp RR_Spectrum_VertE.dat "RR_Spectrum_VertE.dat_$filename3"
     echo "$filename files copied!"
     cp "RR_Spectrum_VertE.dat_$filename3" /home/marlene/uracil/1.S0_snapshots/S1/0-100_S1
